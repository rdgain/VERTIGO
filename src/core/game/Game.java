...
public abstract class Game {
	...
	public void printExpResult() {
		if (analysis) {
			EvoAnalyzer.calcEntropyChosenActions(avatars[0].player);
		}
		String res = "Result " + avatars[0].getWinState().key() + " " + avatars[0].getScore() + " "
				+ this.getGameTick() + " " + actionsToString(EvoAnalyzer.entropyC);
